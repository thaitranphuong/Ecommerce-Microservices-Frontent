...
function Supplier() {
    ...
    const render = async () => {
        let result = await api.getRequest(`/supplier/get-all?page=${page}&limit=5&name=${name}`);
    ...
    const handleDelete = async (id: any) => {
        let result = await api.deleteRequest(`/supplier/delete/${id}`);
        console.log(result);
                                    ...
                                    <tr key={item.id}>
                                        ...
                                        <td>
                                            <div className="flex justify-center items-center">
                                                <Link
                                                    href={`/admin/edit-supplier/${item.id}`}
