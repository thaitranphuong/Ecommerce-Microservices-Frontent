                        ...
                        >
                            ...
                            <div className="flex-1 p-6 ">
                                <div className="text-[40px] mt-2">
                                    Giảm {item.discountPercent.toLocaleString('vi-VN')}%
                                </div>
                                <div className="text-[20px] mt-2 text-gray-600">
                                    Giảm tối đa {item.maxDiscount.toLocaleString('vi-VN')}₫
                                </div>
                                <div>Đơn tối thiểu {item.minValidPrice.toLocaleString('vi-VN')}₫</div>
                                ...
                                <div className="text-red-500">Hạn sử dụng: {convertFromISODate(item.endTime)}</div>
                                <Link
                                    href={'/product'}
