                    ...
                    <div key={1} className={styles.item}>
                        <div className={styles.item_top}>
                            ...
                            <div className={styles.item_top_body}>
                                <div key={1} className={styles.item_top_body_item}>
                                    <Image
                                    ...
                                    <div className={styles.item_top_body_info}>
                                        <div className={styles.item_top_body_info_nameAndPrice}>
                                            <div className={styles.item_top_body_info_name}>
                                                Áo thun nam trơn cổ trụ COTA vải Cotton co giãn, thấm hút mồ hôi, chuẩn
                                                form - BELAIRMAN
                                            </div>
                                            <div className={styles.item_top_body_info_price}>
                                                ₫{(35076).toLocaleString('vi-VN')}
                                            </div>
                                        </div>
                        ...
                        <div className={styles.item_bottom}>
                            <div className={styles.item_bottom_price}>
                                ...
                                <div className={styles.item_bottom_price_number}>
                                    ₫{(36076).toLocaleString('vi-VN')}
                                </div>
                            </div>
                            <button className={styles.item_bottom_btn}>Hủy đơn</button>
                            <button className={styles.item_bottom_btn}>Đã nhận hàng</button>
                        </div>
                    </div>
                </div>
            </div>
